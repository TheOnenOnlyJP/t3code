...
const runGrokInspectCommand = (grokSettings: GrokSettings, environment: NodeJS.ProcessEnv) =>
  Effect.gen(function* () {
...
export const discoverGrokInspectCatalog = Effect.fn("discoverGrokInspectCatalog")(function* (
  ...
  const inspectResult = yield* runGrokInspectCommand(grokSettings, environment).pipe(
